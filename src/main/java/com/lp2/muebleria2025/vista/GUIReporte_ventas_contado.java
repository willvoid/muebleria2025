 ...
 * @author cmendieta
 */
public class GUIReporte_ventas_contado extends javax.swing.JDialog {
    Connection conec;
    /**
     * Creates new form GUIMarca
     */
    public GUIReporte_ventas_contado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btn_reporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_reporteActionPerformed
        ...
        try {
            ...
            JasperReport report = JasperCompileManager.compileReport(
                       "C:\\Users\\HP\\Documents\\NetBeansProjects\\muebleria2025\\src\\main\\java\\reportes\\reporte_ventas_2025.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIReporte_ventas_contado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GUIReporte_ventas_contado dialog = new GUIReporte_ventas_contado(new javax.swing.JFrame(), true);
