 ...
 * @author cmendieta
 */
public class GUICuentasContables extends javax.swing.JDialog {

    /**
     * Creates new form GUIMarca
     */
    public GUICuentasContables(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbo_tipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar", "Ingreso", "Egreso" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUICuentasContables.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GUICuentasContables dialog = new GUICuentasContables(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JComboBox<String> cbo_tipo;
